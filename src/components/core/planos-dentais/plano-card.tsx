...
export function PlanoCard({ plano, onEdit, onIniciar, onConcluir, onCancelar, onView }: PlanoCardProps) {
        ...
        <Card className="transition-shadow hover:shadow-md">
            ...
            <CardFooter className="flex items-center justify-between border-t pt-4">
                ...
                <div className="text-right">
                    {plano.valorDesconto && Number.parseFloat(plano.valorDesconto) > 0 && (
                        <p className="text-xs text-muted-foreground line-through">{formatCurrency(plano.valor)}</p>
                    )}
